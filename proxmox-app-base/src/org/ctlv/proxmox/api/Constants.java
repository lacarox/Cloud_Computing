...
public class Constants {
	...
	public static String USER_NAME = "moulinie"; // votre nom d'utilisateur : XXX
	public static String PASS_WORD = "R@qn8tsZ"; // votre mot de passe . XXX
	...
	public static String CT_BASE_NAME = "ct-tpgei-virt-C3-ct";  // "XX" � remplacer par votre num�ro de bin�me. Exemple: ct-tpgei-virt-A3-ct � concat�ner avec le num�ro du CT
	public static long CT_BASE_ID = 3300;	 // � modifier (cf. sujet de tp) XXX
